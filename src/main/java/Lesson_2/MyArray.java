...
public class MyArray {
    ...
    public void setArr(int value, int idx) {
        arr[idx] = value;
    }
    ...
    public void sortSelect() {
        for (int idx = 0; idx < capacity; idx++) {
            int curr = idx;
            for (int srch = idx + 1; srch < capacity; idx++)
    ...
    public void sortInsert() {
        for (int curr = 0; curr < capacity; curr++) {
